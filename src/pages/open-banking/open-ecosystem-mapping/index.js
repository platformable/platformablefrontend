...
import OBOpenEcosystemTitle from "../../../assets/ob-open-ecosystem-mapping/heroImg.png"
...
export default function index({ data, location }) {
  ...
  return (
    <Layout>
      ...
      <GridDisplay
        gridDisplayClass="hero-section flex flex-col sm:flex-row flex-wrap my-6 container mx-auto py-6 md:px-0 px-5 justify-between items-center"
      ...
      <section className="bg-lightPink py-10 anOpenEcosystemIs sm:mx-auto md:px-0 px-5">
        <div className="container mx-auto md:w-2/5 px-0 lg:px-0 xl:px-3">
          <h3 className="font-bold text-center my-5">An open ecosystem is</h3>
          <p className="italic">
            A network of <strong>equitable participation opportunities</strong>{" "}
            that <strong>allow stakeholders</strong> (including governments and
            ...
            with each other, using open standards, common tools, APIs, and
      ...
      <section className="our-process my-10 ">
        <div className="container mx-auto md:px-0 px-5">
          <div className="px-0 md:px-3 lg:px-0 xl:px-3">
            <h3 className="font-bold text-center my-5">Our process</h3>
            ...
            <div className="our-process-pill w-4/4 md:w-2/4 flex md:flex-nowrap flex-wrap justify-center items-center  py-5 px-10 shadow mx-auto md:rounded-full border-gray-100 shadow">
              ...
              <div className="our-process-text">
                <p className="text-sm md:text-md">
                  Create a range of <strong>tools</strong> to help you
                  understand and strategise around your ecosystem
                </p>
              </div>
            </div>
      ...
      <section className="tools">
        <div className="container mx-auto md:px-0 px-5">
          <div className="tools-cards-container flex flex-wrap md:flex-nowrap gap-4 px-0 md:px-3 lg:px-0 xl:px-3">
            <div className="tools-card-item shadow p-5 rounded-2xl flex-grow md:flex-grow">
              ...
              <h3 className="font-bold mt-5">Panorama</h3>
              <p className="text-sm">
            ...
            <div className="tools-card-item shadow p-5 rounded-2xl flex-grow md:flex-grow">
              ...
              <h3 className="font-bold mt-5">Policy</h3>
              <p className="text-sm">
            ...
            <div className="tools-card-item shadow p-5 rounded-2xl flex-grow md:flex-grow">
              ...
              <h3 className="font-bold mt-5">Process</h3>
              <p className="text-sm">
      ...
      {/* TOP LATESTS 3 POSTS */}
      {/* <h3 className="text-center font-bold my-10">Our Latest Work </h3>
