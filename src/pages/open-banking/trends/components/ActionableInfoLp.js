  ...
  return (
    <section className="bg-card py-3 px-8  rounded-3xl md:mx-12 mx-4 lg:absolute -bottom-80 inset-x-0">
      ...
      <div className="my-0 sm:mx-12 mx-auto justify-between flex flex-wrap items-center">
        ...
        <div className="mb-5 md:flex items-center lg:w-2/5 w-9/12">
        <img src={openFinanceImg} alt="" className="w-40 h-32 product-offer-photo-2 mr-2 object-contain"/>
          <div>
        ...
        <div className="mb-5 md:flex items-center lg:w-2/5 w-9/12">
        <img src={apiImg} alt="" className="w-40 h-32 product-offer-photo-2 mr-2 object-contain"/>
          <div>
            <p className="">API products and how they are being used</p>
          </div>
        </div>
        <div className="mb-5 md:flex items-center lg:w-2/5 w-9/12">
        <img src={pricingImg} alt="" className="w-40 h-32 product-offer-photo-2 mr-2 object-contain"/>
          <div>
            <p className="">Pricing and business models</p>
          </div>
        </div>
        <div className="mb-5 md:flex items-center lg:w-2/5 w-full">
        <img src={globalMoveImg} alt="" className="w-40 h-32 product-offer-photo-2 mr-2 object-contain"/>
          <div>
            <p className="">
