            ...
            <div className="commitment-left px-10 commitment-left-borders py-5">
              <div className="commitment-left-top">
                ...
                <p className="mb-1 md:text-md text-sm">
                  We donate/volunteer a percentage of our work projects to open
                  source projects and we select open source technologies where
                  we can.
                </p>
                <p className="mb-1 md:text-md text-sm">
                ...
                <p className="mb-1 md:text-md text-sm">
                  We offer a 10% discount on our project pricing to open source
                  community organisations and non-profits.
                </p>
                <p className="mb-5 md:text-md text-sm">
                  We are building partnerships with organisations that work on
                  reducing health inequalities and we look for opportunities to
            ...
            <div className="commitment-right px-10 commitment-right-borders py-5">
              <div className="commitment-right-top">
                ...
                <p className="mb-1 md:text-md text-sm">
                  ...
                  workforce that represents all of us who are not traditionally
                  prioritised when building communities, products or services.
                </p>
                <p className="mb-1 md:text-md text-sm">
                  We collect data on the participation and work of businesses
                  that are women-led and have diverse management and we ensure
                  that when we discuss the role of open ecosystems we give
                  representation to these businesses. We ensure that when we
                  discuss open ecosystems we reflect on whether they are
                  supporting the needs of all market segments and use case
                  needs.
                </p>
                <p className="mb-1 md:text-md text-sm">
                    ...
                    <div className="p-4 md:p-6 md:block md:px-5 px-5">
                      <div className="flex gap-4 items-center mb-5 justify-center ">
                        ...
                        <div>
                          ...
                          {x.pronoun && (
                            <p className="text-xs text-center">{x.pronoun}</p>
                          )}
                        </div>
                      </div>
