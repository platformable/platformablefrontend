    ...
    <Layout>
      ...
      <section id="os-product-idea-workshop" className="os-pwi-hero">
        <div className="os-product-idea-workshop-hero container mx-auto md:px-0 px-5 items-center">
          <div className="os-product-idea-workshop-hero-left">
            <h3 className="font-black text-4xl pt-5">
              Building green fintech:
            </h3>
            <h3 className="font-black text-4xl mb-3">
              {" "}
        ...
        <div className="os-product-idea-workshop-our-workshop py-14">
          ...
          <div className="os-product-idea-workshop-4-square-container container mx-auto  py-10 md:px-0 px-5">
            <div className="os-product-idea-workshop-4-square-container-box my-5 p-5 rounded-xl  h-full">
              <p>
                Identifying <span>target market segments</span> and
            ...
            <div className="os-product-idea-workshop-4-square-container-box my-5 p-5 rounded-xl  h-full">
              <p>Aligning product ideas with their potential impact</p>
            </div>
            <div className="os-product-idea-workshop-4-square-container-arrow md:block hidden">
              <img src={ArrowImg} alt="" />
            </div>
            ...
            <div className="os-product-idea-workshop-4-square-container-box my-5 p-5 rounded-xl  h-full">
              <p>
                in the areas causing the greatest sustainability risk threats
              </p>
            </div>
            <div className="os-product-idea-workshop-4-square-container-arrow md:block hidden">
              <img src={ArrowImg} alt="" />
            ...
            <div className="os-product-idea-workshop-4-square-container-box my-5 p-5 rounded-xl  h-full">
              <p>
                Creating products and features that enable action to improve
                sustainability
              </p>
            </div>
          </div>
      ...
      <section>
        <div className="os-product-ideation-workshop green-fintech-challenge bg-main-color py-10">
          <div className="container mx-auto md:px-0 px-5">
            <h3 className="font-black text-white text-center my-10">
              The green fintech{" "}
          ...
          <div className="os-product-ideation-workshop-green-fintech-challenge-container container mx-auto md:px-0 px-5">
            <div className="os-product-ideation-workshop-green-fintech-challenge-box h-full p-5 text-center rounded-lg">
              ...
              <p className="text-white">
                Consumers are increasingly demanding sustainability from the
            ...
            <div className="os-product-ideation-workshop-green-fintech-challenge-box h-full p-5 text-center rounded-lg">
              ...
              <p className="text-white">
                Regulations are driving business sustainability performance and
            ...
            <div className="os-product-ideation-workshop-green-fintech-challenge-box h-full p-5 text-center rounded-lg">
              ...
              <p className="text-white">
                ...
                and finance products that create tangible sustainability impacts
              </p>
            </div>
            <div className="os-product-ideation-workshop-green-fintech-challenge-box h-full p-5 text-center rounded-lg">
              <img src={greenFintechImg4} alt="" className="h-16 mb-5" />
              <p className="text-white">
                Green fintech business models and pricing strategies are still
        ...
        <div className="os-product-ideation-workshop-section5 my-10">
          <div className="container mx-auto os-product-ideation-workshop-section5-container md:px-0 px-5">
            ...
            <div className="os-product-ideation-workshop-section5-right">
              <h4 className="font-black os-product-ideation-workshop-section5-right-color-green mb-5">
                Product ideation workshop 1:
              </h4>
              <h3 className="font-black mb-5 text-3xl">Consume API products</h3>
      ...
      <section>
        <div className="os-product-ideation-workshop-section6 py-20">
          <div className="container mx-auto md:px-0 px-5">
            <h3 className="font-black mb-10 text-center text-3xl">What <span className="bg-main-color text-white px-2">you will learn</span></h3>
          </div>
          <div className="container mx-auto md:px-0 px-5">
      ...
      <section className="bg-main-color py-10">
      ...
      <section id="os-pwi-form">
        <div className="os-product-idea-workshop-our-workshop py-10">
          <div className="container mx-auto os-product-ideation-workshop-section5-container md:px-0 px-5">
            <div className="os-product-ideation-workshop-section5-left">
              <img src={isIcon} alt="" />
            </div>
            <div className="os-product-ideation-workshop-section5-right">
              ...
              <h3 className="font-black mb-5 text-3xl">We publish Open Sustainability analysis and insights</h3>

              <p className=" mb-3">
              Hear more about our Open Sustainability work
Create positive impact and generate revenue
              ...
              />
              <button
                className="px-8 rounded-r-lg bg-main-color  text-white font-bold p-4 uppercase border-yellow-500 border-t border-b border-r"
