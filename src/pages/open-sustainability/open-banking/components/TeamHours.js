...
const TeamHours = () => {
  return (
    <section className="team-section container mx-auto py-8 px-2 rounded-3xl my-14  mx-4 text-center">
      <h2 className="pb-3 font-bold">Additional analyst team hours</h2>
