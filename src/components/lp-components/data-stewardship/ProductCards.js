...
const ProductCards = () => {
  const images = [
    ...
    },
    {
      src:mentorshipImg,
      title:'Mentorship',
      paragraph:'Training can also be provided 1:1 alongside a  mentorship program where key data staff are supported to improve their data stewardship skills'
    },
  ];
